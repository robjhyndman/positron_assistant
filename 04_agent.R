...
# demo_data.csv is created below for use in Example 1.
...
#
# "Create a new R script that loads demo_data.csv, performs basic data
...
# Paste this into the Agent chat:
#
# "Update all ggplot graphics in 04_agent.R to use a colour-blind
...
mtcars |>
  ...
  labs(
    title = "Cars by Cylinders and Transmission",
    x = "Cylinders",
    y = "Count",
    fill = "Transmission"
  )
